...
/**
 * This is the item provider adapter for a {@link enterprise.Employe} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EmployeItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						EnterprisePackage.Literals.EMPLOYE__NAME, true, false, false,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Employe_surname_feature",
								"_UI_Employe_type"),
						EnterprisePackage.Literals.EMPLOYE__SURNAME, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addDesktopPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Employe_desktop_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Employe_desktop_feature",
								"_UI_Employe_type"),
						EnterprisePackage.Literals.EMPLOYE__DESKTOP, true, false, true, null, null, null));
	}
