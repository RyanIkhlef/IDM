...
/**
 * This is the item provider adapter for a {@link enterprise2.Computer} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ComputerItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Computer_name_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Computer_name_feature",
								"_UI_Computer_type"),
						Enterprise2Package.Literals.COMPUTER__NAME, true, false, false,
	...
	protected void addUsersPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Computer_users_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Computer_users_feature",
								"_UI_Computer_type"),
						Enterprise2Package.Literals.COMPUTER__USERS, true, false, true, null, null, null));
	}
	...
	protected void addRoomPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Computer_room_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Computer_room_feature",
								"_UI_Computer_type"),
						Enterprise2Package.Literals.COMPUTER__ROOM, true, false, true, null, null, null));
	}
