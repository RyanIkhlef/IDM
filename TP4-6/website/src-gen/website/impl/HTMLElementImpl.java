 ...
 * </p>
 * <ul>
 *   <li>{@link website.impl.HTMLElementImpl#getId <em>Id</em>}</li>
 *   <li>{@link website.impl.HTMLElementImpl#getClass_ <em>Class</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class HTMLElementImpl extends MinimalEObjectImpl.Container implements HTMLElement {
	...
	protected EClass eStaticClass() {
		return WebsitePackage.Literals.HTML_ELEMENT;
	}
	...
	public void setId(String newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WebsitePackage.HTML_ELEMENT__ID, oldId, id));
	}
	...
	public EList<String> getClass_() {
		if (class_ == null) {
			class_ = new EDataTypeUniqueEList<String>(String.class, this, WebsitePackage.HTML_ELEMENT__CLASS);
		}
		return class_;
	}
