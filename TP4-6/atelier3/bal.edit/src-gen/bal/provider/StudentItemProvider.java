...
/**
 * This is the item provider adapter for a {@link bal.Student} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class StudentItemProvider extends UserItemProvider {
	...
	protected void addCommandPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Student_command_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Student_command_feature",
								"_UI_Student_type"),
						BalPackage.Literals.STUDENT__COMMAND, true, false, true, null, null, null));
	}
	...
	protected void addPaymentsPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Student_payments_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Student_payments_feature",
								"_UI_Student_type"),
						BalPackage.Literals.STUDENT__PAYMENTS, true, false, true, null, null, null));
	}
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(BalPackage.Literals.STUDENT__PARENT);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors
				.add(createChildParameter(BalPackage.Literals.STUDENT__PARENT, BalFactory.eINSTANCE.createParent()));
	}
