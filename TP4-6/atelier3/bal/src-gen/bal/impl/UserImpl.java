 ...
 * </p>
 * <ul>
 *   <li>{@link bal.impl.UserImpl#getName <em>Name</em>}</li>
 *   <li>{@link bal.impl.UserImpl#getSurname <em>Surname</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class UserImpl extends MinimalEObjectImpl.Container implements User {
	...
	protected EClass eStaticClass() {
		return BalPackage.Literals.USER;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BalPackage.USER__NAME, oldName, name));
	}
	...
	public void setSurname(String newSurname) {
		...
		surname = newSurname;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BalPackage.USER__SURNAME, oldSurname, surname));
	}
