...
/**
 * This is the item provider adapter for a {@link enterprise2.Room} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RoomItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addStageNumberPropertyDescriptor(object);
		}
	...
	protected void addRoomNumberPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Room_roomNumber_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Room_roomNumber_feature", "_UI_Room_type"),
						Enterprise2Package.Literals.ROOM__ROOM_NUMBER, true, false, false,
						ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE, null, null));
	}

	/**
	 * This adds a property descriptor for the Stage Number feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addStageNumberPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Room_stageNumber_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Room_stageNumber_feature",
								"_UI_Room_type"),
						Enterprise2Package.Literals.ROOM__STAGE_NUMBER, true, false, false,
						ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE, null, null));
	}
