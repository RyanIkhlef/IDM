 ...
 * </p>
 * <ul>
 *   <li>{@link usd.impl.ParagraphImpl#getContents <em>Contents</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ParagraphImpl extends ElementImpl implements Paragraph {
	...
	public EList<Element> getContents() {
		if (contents == null) {
			contents = new EObjectContainmentEList<Element>(Element.class, this, UsdPackage.PARAGRAPH__CONTENTS);
		}
		return contents;
	}
