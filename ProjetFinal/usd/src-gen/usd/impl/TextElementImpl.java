 ...
 * </p>
 * <ul>
 *   <li>{@link usd.impl.TextElementImpl#getTextContent <em>Text Content</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class TextElementImpl extends ElementImpl implements TextElement {
	...
	public void setTextContent(String newTextContent) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UsdPackage.TEXT_ELEMENT__TEXT_CONTENT, oldTextContent,
					textContent));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case UsdPackage.TEXT_ELEMENT__TEXT_CONTENT:
