...
public class SectionItemProvider extends ElementItemProvider {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors
				.add(createChildParameter(UsdPackage.Literals.SECTION__CONTENTS, UsdFactory.eINSTANCE.createDiv()));

		newChildDescriptors
				.add(createChildParameter(UsdPackage.Literals.SECTION__CONTENTS, UsdFactory.eINSTANCE.createSpan()));
		...
		newChildDescriptors.add(
				createChildParameter(UsdPackage.Literals.SECTION__CONTENTS, UsdFactory.eINSTANCE.createEmphasis()));

		newChildDescriptors
				.add(createChildParameter(UsdPackage.Literals.SECTION__CONTENTS, UsdFactory.eINSTANCE.createText()));
