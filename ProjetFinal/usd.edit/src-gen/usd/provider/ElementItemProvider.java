...
public class ElementItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addClassPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Element_class_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Element_class_feature",
								"_UI_Element_type"),
						UsdPackage.Literals.ELEMENT__CLASS, true, false, false,
