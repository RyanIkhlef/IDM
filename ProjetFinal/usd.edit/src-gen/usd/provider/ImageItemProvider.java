...
public class ImageItemProvider extends ElementItemProvider {
	...
	protected void addImgSrcPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						UsdPackage.Literals.IMAGE__IMG_SRC, true, false, false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(UsdPackage.Literals.IMAGE__LINK);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors
				.add(createChildParameter(UsdPackage.Literals.IMAGE__LINK, UsdFactory.eINSTANCE.createLink()));
	}
