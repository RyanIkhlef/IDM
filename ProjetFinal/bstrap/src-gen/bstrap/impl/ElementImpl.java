 ...
 * </p>
 * <ul>
 *   <li>{@link bstrap.impl.ElementImpl#getId <em>Id</em>}</li>
 *   <li>{@link bstrap.impl.ElementImpl#getClasses <em>Classes</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class ElementImpl extends MinimalEObjectImpl.Container implements Element {
	...
	protected EClass eStaticClass() {
		return BstrapPackage.Literals.ELEMENT;
	}
	...
	public void setId(String newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BstrapPackage.ELEMENT__ID, oldId, id));
	}
	...
	public void setClasses(String newClasses) {
		...
		classes = newClasses;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BstrapPackage.ELEMENT__CLASSES, oldClasses, classes));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case BstrapPackage.ELEMENT__ID:
			return getId();
		case BstrapPackage.ELEMENT__CLASSES:
			return getClasses();
		}
