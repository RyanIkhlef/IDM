 ...
 * </p>
 * <ul>
 *   <li>{@link bstrap.impl.BlockQuoteImpl#getQuotes <em>Quotes</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BlockQuoteImpl extends ElementImpl implements BlockQuote {
	...
	public EList<Element> getQuotes() {
		if (quotes == null) {
			quotes = new EObjectContainmentEList<Element>(Element.class, this, BstrapPackage.BLOCK_QUOTE__QUOTES);
		}
		return quotes;
	}
