 ...
 * </p>
 * <ul>
 *   <li>{@link bstrap.impl.TitleImpl#getLevel <em>Level</em>}</li>
 *   <li>{@link bstrap.impl.TitleImpl#getContents <em>Contents</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TitleImpl extends ElementImpl implements Title {
	...
	public EList<Element> getContents() {
		if (contents == null) {
			contents = new EObjectContainmentEList<Element>(Element.class, this, BstrapPackage.TITLE__CONTENTS);
		}
		return contents;
	}
